...
listener.energy_threshold = 3650
engine = pyttsx3.init()
...
my_bot = ChatBot(name='JARVIS', read_only=True, logic_adapters=[
...
playback(command_box, play_button, "I have been successfully uploaded. We are online and ready!")
while True: 
